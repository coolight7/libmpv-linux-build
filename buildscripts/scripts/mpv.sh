...
ln -s /usr/local/share/wayland-protocols /home/coolight/program/media/libmpv-linux-build/buildscripts/prefix/x86_64/usr/local/share/wayland-protocols

# c++std: libjxl、shaderc
# 由 mediaxx 静态链接标准库并导出符号，libmpv 动态链接使用
CFLAGS="$CFLAGS -I$prefix_dir/include -I/usr/include/pipewire-0.3/ -I/usr/include/spa-0.2/" CXXFLAGS="$CXXFLAGS -I$prefix_dir/include -I/usr/include/pipewire-0.3/ -I/usr/include/spa-0.2/" LDFLAGS="$LDFLAGS -L$prefix_dir/lib/ $default_ld_cxx_stdlib -lm" meson setup $build \
